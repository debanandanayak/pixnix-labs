...
export default function Home() {
    return <div className="min-h-screen dark:bg-background/50 bg-white/50 text-foreground transition-colors duration-300 relative">
        ...
        <div className="container w-[90%] m-auto my-10 bg-transparent">
            <div className="flex flex-col-reverse p-6 gap-2.5 justify-center items-center md:flex-row">
                <div className="md:flex-1/2 justify-center">
                    ...
                    {/* <SplitText /> */}
                    <p className="font-semibold text-xl text-primary/70 animate-fadeIn duration-75 transition-all delay-200">Lorem ipsum dolor nsectetur adipisicing elit. Amet, nobis!</p>
                ...
                <FadeContent>
                    <div className="inline-block rounded-2xl md:flex-1/2 ">
                        <Image className="backdrop-blur-xs drop-shadow-2xl rounded-2xl" src={"/hero-image.png"} alt={"hero image"} width={500} height={500} />
                    </div>
                </FadeContent>
            </div>
        </div>
